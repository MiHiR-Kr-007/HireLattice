...
CREATE TYPE application_status AS ENUM ('APPLIED', 'RANKED', 'SCHEDULED', 'INTERVIEWED', 'HIRED', 'REJECTED', 'STALLED_NO_SLOTS');
CREATE TYPE slot_status AS ENUM ('AVAILABLE', 'RESERVED', 'CONFIRMED', 'CANCELLED');
CREATE TYPE interview_status AS ENUM ('OFFERED', 'CONFIRMED', 'DECLINED', 'EXPIRED', 'COMPLETED', 'CANDIDATE_NO_SHOW', 'INTERVIEWER_NO_SHOW', 'INTERVIEWER_NO_SHOW_CLAIMED', 'CANCELLED_BY_INTERVIEWER');
